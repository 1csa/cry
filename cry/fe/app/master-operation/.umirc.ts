...
const config: IConfig = {
  ...
  base: `/app/master-operation`,
  publicPath: isProd ? `/dist/app/master-operation/` : '/',
  outputPath: `../../../www/dist/app/master-operation/`,
  proxy: {
    '/api': {
  ...
  plugins: [
    ...
    [
      'umi-plugin-react',
      {
        ...
        headScripts: [{ src: 'http://pandora.yidian-inc.com/static/modules/common/Logger.js' }],
      },
    ],
  ],
};
