...
const initTableList: TableItemType[] = [
  {
    title: '用户ID',
    dataIndex: ['material', 'suspect', 'id'],
    key: 'id',
  },
  {
    title: '用户昵称',
    dataIndex: ['material', 'suspect', 'nickname'],
    key: 'nickname',
  },
  {
    title: '审核状态',
...
export const filterTableKey = 'docid,part_zone_cn,title,machine_status,stageText,machine_result,user';
